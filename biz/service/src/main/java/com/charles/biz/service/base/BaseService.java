package com.charles.biz.service.base;


import com.charles.common.model.base.IdAutoIncrementStrategy;
import com.charles.common.page.Page;
...
public interface BaseService<T> {
    ...
    <Entity extends IdAutoIncrementStrategy> void distinct(List<Entity> list);
